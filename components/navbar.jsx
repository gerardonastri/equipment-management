          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="hidden lg:flex items-center space-x-2 px-3 py-2 text-muted-foreground hover:text-foreground transition-colors"
              >
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-16 right-0 bottom-0 w-80 max-w-[85vw] bg-white border-l border-border z-50 lg:hidden"
            >
